...
def build_summary_two_col(
    ...
    """항목/값 2열 요약 테이블 생성(요약 시트에 열로 붙일 원본)"""
...
# ----------------------
# Inputs (LIVE: form 제거, 체크박스 즉시 반영)
# ----------------------
...
disable_costs = manual_total_invest_on or manual_total_subsidy_on  # 총액 수동 시 원가/1기당 보조금 입력 잠금
